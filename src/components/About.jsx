        ...
        <div className="md:grid md:grid-cols-7 flex flex-col gap-10 text-justify">
          <div className="col-span-4 text-[#d0e1f9]">
            <p>
              ...
              which focuses on robotics. In UKMFT SOKET, I am part of the robot
              team and have learned a lot,{" "}
              <span className="text-[#4d648d]">
                especially in robotics programming,
              </span>{" "}
              leading me to participate in Indonesian robot contests.
            </p>
            <p className="mt-3">
              Fast-forward to my final semester in 2022, I began to develop an
              interest in web programming, particularly in{" "}
              <span className="text-[#4d648d]">front-end web development</span>.
              I started learning a lot about{" "}
              <span className="text-[#4d648d]">front-end web development </span>
              from various social media platforms and took part in several
          ...
          <div className="flex justify-center col-span-3">
            <img
              src={shofiyul}
              alt=""
              className="lg:w-[23vw] lg:h-[28vw] md:w-[30vw] md:h-[35vw] w-[290px] rounded-md css-box-shadow [box-shadow:_6px_6px_0_rgb(15,23,42),_10px_10px_0_rgb(77,100,128)]"
            />
          </div>
        </div>
      </div>
