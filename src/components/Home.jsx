  ...
  return (
    <>
      <div
        ...
        <div className="pb-7">
          <h1 className="md:text-[6vw] text-[9vw] font-bold text-[#d0e1f9] sm:leading-none ">
            Shofiyul Fuad
          </h1>
        ...
        <div className="">
          <a href="https://drive.google.com/file/d/1fCcf-6tXc03emazKexw06GOj4KV8jzH7/view?usp=sharing">
            <button className="border-2 text-[#d0e1f9] px-10 py-4 rounded-md hover:[box-shadow:_4px_4px_0_rgb(204,168,135)]">
              Check out my resume
            </button>
          </a>
        </div>
